    ...
    array(
        ...
        'settings' => array(
            ...
            array(
                ...
                'css' => 'css_rules',
                'css_rules' => array(
                    'top' => '[ms_id] .flexslider ul.flex-direction-nav li a { bottom: unset; top: calc([ms_field_value]% + 50px); transform: translateY(-[ms_field_value]%) }', // Take [ms_field_value] from arrows_vertical_position_offset
            ...
            array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'color',
                        'default' => 'rgba(255,255,255,0)',
                        'css' => '[ms_id] .flexslider ol.flex-control-nav li a.flex-active { background: [ms_value] }'
                    )
                )
            ),
            array(
