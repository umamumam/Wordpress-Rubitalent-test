    ...
    array(
        ...
        'settings' => array(
            ...
            array(
                ...
                'css' => 'css_rules',
                'css_rules' => array(
                    'top' => '[ms_id] .flexslider ul.flex-direction-nav li a { bottom: unset; top: [ms_field_value]%; transform: translateY(-[ms_field_value]%); }', // Take [ms_field_value] from arrows_vertical_position_offset
            ...
            array(
                ...
                'fields' => array(
                    array(
                        ...
                        'type' => 'color',
                        'default' => 'rgba(255,255,255,0.95)',
                        'css' => '[ms_id] .flexslider ol.flex-control-nav:not(.flex-control-thumbs) li a:not(.flex-active):not(:hover) { border-color: [ms_value] }'
                    ),
                    array(
                        'label' => esc_html__('Hover', 'ml-slider'),
                    ...
                    array(
                        ...
                        'type' => 'color',
                        'default' => 'rgba(255,255,255,0.95)',
                        'css' => '[ms_id] .flexslider ol.flex-control-nav:not(.flex-control-thumbs) li a.flex-active { border-color: [ms_value] }'
                    )
                )
            ),
            array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'color',
                        'default' => '#ffffff',
                        'css' =>  '[ms_id] .flexslider ol.flex-control-nav:not(.flex-control-thumbs) li a:not(.flex-active):hover { color: [ms_value] }'
                    ),
                    array(
                        'label' => esc_html__('Active', 'ml-slider'),
                        ...
                        'type' => 'color',
                        'default' => '#ffffff',
                        'css' => '[ms_id] .flexslider ol.flex-control-nav:not(.flex-control-thumbs) li a.flex-active { color: [ms_value] }'
                    )
                )
            ),
            array(
